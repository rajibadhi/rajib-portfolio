...
const experience = [
  {
    ...
    company: "Hospitality & Gaming Industry",
    period: "Current",
    desc: "End-to-end IT operations — server administration, Active Directory, Sophos firewall management, CCTV infrastructure, network troubleshooting, and user support in a high-availability enterprise environment.",
  },
  {
    icon: "💻",
...
const stats = [
  { num: "10+",  label: "Years IT Experience" },
    ...
    <>
      ...
      {open && (
        <div className="mobileMenu">
          {links.map(l => (
            <a key={l.label} className="mobileLink" href={l.href} onClick={close}>
              {l.label}
            </a>
          ))}
          <a className="mobileLink mobileCta" href="#contact" onClick={close}>
            Hire Me
          </a>
        </div>
      )}
            ...
            <div className="heroSplit">
              <div className="heroLeft">
                ...
                <div className="heroActions">
                  ...
                  {RESUME_URL !== "#" && (
                    <a href={RESUME_URL} target="_blank" rel="noreferrer" className="btn outline">↓ Resume</a>
                  )}
                </div>
              </div>
